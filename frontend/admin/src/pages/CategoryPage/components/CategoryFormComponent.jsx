...
export default function CategoryFormComponent({ openSidebar, onCloseDrawer, dataEdit }) {
            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    validator: () => (files && files?.length > 0) ? Promise.resolve() : Promise.reject("Veuillez ajouter une image de la categorie"),
                  },
                ]}
              >
                <UploadFile  
