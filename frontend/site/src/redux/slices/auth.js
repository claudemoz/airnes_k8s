...
import { registerService, loginService, logoutService, getCurrentUserService, verifyEmailService,
   reverifyEmailService, resetPasswordService, generateForgetPasswordlinkService, updateUserService,
   updatePasswordService} from "@/api.services";
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(login.rejected, (state, { payload }) => {
        state.isLoading = true;
        state.error = payload?.message || "Combinaison email/mot de passe incorrecte";
        // state.error = null;
      })
